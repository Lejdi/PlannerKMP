...
kotlin {
    ...
    sourceSets {
        commonMain.dependencies {
            ...
            // api: LocalDate and LocalTime are in this feature's own public signatures —
            // TaskSchedule, Task, DashboardDay. It worked through core:common's api(…), which
            // is the same accident one module further along.
            api(libs.kotlinx.datetime)
        }
        androidMain.dependencies {
            implementation(libs.compose.uiToolingPreview)
            // No platform SQLDelight driver here. Nothing in this module names AndroidSqliteDriver
            // or NativeSqliteDriver: `core:database`'s DatabaseDriverFactory owns driver creation
            // and declares both itself. Declaring them again described a dependency this feature
            // does not have, in the one file whose comments are otherwise most careful about that.
        }
...
compose.resources {
    publicResClass = true
    packageOfResClass = "pl.lejdi.plannerkmp.feature.tasks.resources"
